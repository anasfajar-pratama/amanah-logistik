            ...
            <div className={`flex items-center gap-3 px-3 py-1.5 rounded-xl transition-all duration-300 ${
              ...
              <img src="/logo-web.png" alt={companyName}
                className={`h-10 w-auto ${
                  !scrolled ? 'drop-shadow-[0_0_8px_rgba(255,255,255,0.8)] brightness-[1.1]' : ''
                }`} />
              <span className={`font-bold text-lg tracking-tight ${scrolled ? 'text-primary-800' : 'text-white'}`}>
                {companyName}
              </span>
            </div>
                    ...
                    {submitted ? (
                      ...
                      <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button type="submit" disabled={submitting}
                          className="w-full bg-accent-500 hover:bg-accent-600 disabled:opacity-60 text-white font-bold py-4 rounded-xl transition-colors text-base">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid md:grid-cols-4 gap-10">
            <div className="md:col-span-2">
              <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm mb-4">
